...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        "flex-1 text-xs/relaxed outline-none transition-all duration-200 data-[state=active]:animate-in data-[state=active]:fade-in-0 data-[state=active]:slide-in-from-bottom-2.5",
        className
      )}
      {...props}
    />
