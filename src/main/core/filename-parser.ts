...
export function extractDateFromFilename(filename: string): Date | null {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    const m = clean.match(/^P[_-]?(\d{4})(\d{2})(\d{2})[_-](\d{2})(\d{2})(\d{2})/);
    if (m) {
      const d = createValidDate(+m[1], +m[2] - 1, +m[3], +m[4], +m[5], +m[6]);
      if (d) return d;
    }
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    const m1 = clean.match(/\bDJI[_-](\d{4})(\d{2})(\d{2})(\d{2})(\d{2})(\d{2})/i);
    if (m1) {
      const d = createValidDate(+m1[1], +m1[2] - 1, +m1[3], +m1[4], +m1[5], +m1[6]);
      if (d) return d;
    }
    // Dashed: DJI_2024-03-15-14-30-22
    const m2 = clean.match(/\bDJI[_-](\d{4})-(\d{2})-(\d{2})-(\d{2})-(\d{2})-(\d{2})/i);
    if (m2) {
      const d = createValidDate(+m2[1], +m2[2] - 1, +m2[3], +m2[4], +m2[5], +m2[6]);
      if (d) return d;
    }
  }
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    const m1 = clean.match(/^(\d{4})(\d{2})(\d{2})-(\d{2})(\d{2})(\d{2})[A-Z]?$/);
    if (m1) {
      const d = createValidDate(+m1[1], +m1[2] - 1, +m1[3], +m1[4], +m1[5], +m1[6]);
      if (d) return d;
    }
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    const m1 = clean.match(/(?:^|[^0-9])(\d{4})(\d{2})(\d{2})_(\d{2})(\d{2})(\d{2})(?:$|[^0-9])/);
    if (m1) {
      const d = createValidDate(+m1[1], +m1[2] - 1, +m1[3], +m1[4], +m1[5], +m1[6]);
      if (d) return d;
    }
    ...
    if (m3) {
      const d = createValidDate(+m3[1], +m3[2] - 1, +m3[3], +m3[4], +m3[5], +m3[6]);
      if (d) return d;
    }
  }
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    const m1 = clean.match(/Screenshot[_-](\d{4})-(\d{2})-(\d{2})-(\d{2})-(\d{2})-(\d{2})/i);
    if (m1) {
      const d = createValidDate(+m1[1], +m1[2] - 1, +m1[3], +m1[4], +m1[5], +m1[6]);
      if (d) return d;
    }
    // Compact: Screenshot_20240315-143022
    const m2 = clean.match(/Screenshot[_-](\d{4})(\d{2})(\d{2})-(\d{2})(\d{2})(\d{2})/i);
    if (m2) {
      const d = createValidDate(+m2[1], +m2[2] - 1, +m2[3], +m2[4], +m2[5], +m2[6]);
      if (d) return d;
    }
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    const m = clean.match(/(\d{4})-(\d{2})-(\d{2})[T _](\d{2})[:-](\d{2})[:-](\d{2})/);
    if (m) {
      const d = createValidDate(+m[1], +m[2] - 1, +m[3], +m[4], +m[5], +m[6]);
      if (d) return d;
    }
