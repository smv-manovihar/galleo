...
export interface DuplicateAuditHistoryDialogItem {
...
const HistoryRow = memo(
  ({
    ...
    index: number
    item: DuplicateAuditHistoryDialogItem
    isChecked: boolean
    isKeep: boolean
    isDelete: boolean
    onSingleAction: (
    ...
    onPreview: (item: DuplicateAuditHistoryDialogItem) => void
    translateY: number
...
interface DuplicateAuditHistoryDialogProps {
  isOpen: boolean
  onOpenChange: (open: boolean) => void
  items: DuplicateAuditHistoryDialogItem[]
...
export const DuplicateAuditHistoryDialog: React.FC<
  DuplicateAuditHistoryDialogProps
