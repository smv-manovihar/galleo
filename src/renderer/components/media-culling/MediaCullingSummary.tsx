...
export const MediaCullingSummary: React.FC<MediaCullingSummaryProps> = ({ onBackToQueue }) => {
      ...
      <div className="w-full max-w-lg space-y-4">
        ...
        <div className="border border-border bg-card rounded-2xl shadow-sm p-6 flex flex-col items-center gap-5 text-center">
          ...
          <div className="space-y-1">
            <h2 className="font-heading font-bold text-sm text-foreground tracking-tight">Session complete</h2>
            <p className="text-xs text-muted-foreground">
              {details.deleteCount > 0
                ...
                : 'All files reviewed — no deletions pending.'}
            </p>
          </div>
          {/* Stat tiles */}
