            ...
            <div className="absolute inset-x-0 bottom-0 z-10 flex flex-col gap-1.5 px-2 pb-2 pt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              ...
              >
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="flex-1 h-7 rounded-md bg-white/10 hover:bg-white/30! text-white/80 hover:text-white! border border-white/15 hover:border-white/30! cursor-pointer transition-colors"
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-7 w-7 rounded-md bg-white/10 hover:bg-white/30! text-white/80 hover:text-white! border border-white/15 hover:border-white/30! cursor-pointer shrink-0 transition-colors"
                    >
