    ...
    <div className="flex h-full flex-col justify-between space-y-2">
      ...
      <div className="space-y-2 rounded-xl border border-border/50 bg-muted/20 p-2.5">
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          ...
          <span className="py-0.5 rounded border border-primary/20 bg-primary/10 px-1 font-bold text-primary">
            100% Match
          </span>
        </div>
        ...
        <div className="relative grid grid-cols-2 gap-2.5">
          ...
          <div className="flex min-h-20 flex-col justify-between space-y-1 rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-2">
            <div className="flex items-center justify-between">
              <span className="max-w-16 truncate font-mono text-xs text-foreground">
                IMG_0920.jpg
              </span>
              <span className="py-0.5 rounded bg-emerald-500/10 px-1 text-xs font-semibold text-emerald-600 dark:text-emerald-400">
                KEEP
              </span>
            </div>
            <div className="space-y-0.5 border-t border-border/30 pt-1 text-xs text-muted-foreground">
              <div>
          ...
          <div
            className={`flex min-h-20 flex-col justify-between space-y-1 rounded-lg border p-2 transition-all duration-300 ${
              removedDuplicate
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span
                className={`py-0.5 rounded border px-1 text-xs font-semibold ${
                  removedDuplicate
          ...
          {!removedDuplicate && (
            <div className="absolute top-1/2 left-1/2 flex h-5 w-5 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-muted bg-border shadow-sm">
      ...
      {!removedDuplicate ? (
        <Button
          className="h-6 w-full cursor-pointer gap-1 bg-primary text-xs font-semibold text-primary-foreground shadow-sm transition-colors hover:bg-primary/95"
        ...
        <div className="flex items-center justify-between py-0.5 text-xs">
          ...
          <Button
            variant="ghost"
            className="h-5 cursor-pointer px-1.5 text-xs text-muted-foreground underline"
    ...
    <div className="flex h-full flex-col justify-between space-y-2">
      {step === 0 && (
        <div className="space-y-2">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between rounded border border-border/40 bg-muted/20 p-1.5 text-xs">
            ...
            <div className="flex items-center justify-between rounded border border-amber-500/10 bg-amber-500/5 p-1.5 text-xs">
              <span className="flex items-center gap-1.5 truncate">
              ...
              <span className="py-0.5 shrink-0 rounded bg-amber-500/10 px-1 text-xs font-medium text-amber-600 dark:text-amber-400">
                Screenshot
              </span>
            </div>
            <div className="flex items-center justify-between rounded border border-orange-500/10 bg-orange-500/5 p-1.5 text-xs">
              <span className="flex items-center gap-1.5 truncate">
              ...
              <span className="py-0.5 shrink-0 rounded bg-orange-500/10 px-1 text-xs font-medium text-orange-600 dark:text-orange-400">
                Blurry
              </span>
            </div>
          </div>
      ...
      {step === 2 && (
        <div className="space-y-2">
          ...
          <div className="space-y-1.5">
            <div className="space-y-1.5 rounded border border-emerald-500/10 bg-emerald-500/5 p-2 text-xs">
            ...
            <div className="flex items-center justify-between rounded border border-border/50 bg-muted/40 p-1.5 text-xs">
              <span className="flex items-center gap-1 truncate text-muted-foreground">
                <Trash2 className="h-3 w-3 shrink-0 text-muted-foreground" />
                <span className="truncate">Moved to Recycle Bin</span>
              </span>
              <span className="py-0.5 shrink-0 rounded bg-muted px-1 text-xs font-medium text-muted-foreground">
                2 clutter items
              </span>
            </div>
          </div>
...
const FeatureShowcaseVisualizer: React.FC = () => {
  ...
  return (
    <TooltipProvider>
      <div className="flex w-full flex-col justify-between py-0.5 font-sans text-xs select-none lg:h-87.5">
        <div className="flex flex-1 flex-col justify-between overflow-hidden rounded-xl border border-border/80 bg-card/65 shadow-lg backdrop-blur-sm">
            ...
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <span className="max-w-full truncate text-xs tracking-tight">
                    {tab.label}
                  </span>
                </button>
              )
          ...
          <div className="flex min-h-48 flex-1 flex-col justify-between bg-card/25 p-3">
  ...
  return (
    <TooltipProvider>
      <div className="flex min-h-full items-center justify-center bg-background p-4 font-sans md:p-6">
        <div className="grid max-h-[calc(100vh-40px)] w-full max-w-5xl grid-cols-1 gap-0 overflow-hidden rounded-2xl border border-border/85 bg-card/40 shadow-2xl backdrop-blur-md lg:h-135 lg:grid-cols-12">
          ...
          <div className="flex flex-col justify-between space-y-6 p-6 md:p-8 lg:col-span-7">
            ...
            <div className="space-y-4 pt-1">
              <div className="flex gap-3">
                <div className="mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded border border-primary/20 bg-primary/10 text-primary">
            ...
            <div className="space-y-3 pt-1">
              ...
              <div className="flex flex-col gap-2">
                <Button
                  className="h-10 w-full cursor-pointer gap-2 bg-primary text-xs font-medium text-primary-foreground shadow-md transition-colors hover:bg-primary/95"
                ...
                {/* Privacy Banner */}
                <div className="flex items-center gap-2 rounded-lg border border-primary/10 bg-primary/5 p-2 text-xs text-muted-foreground">
