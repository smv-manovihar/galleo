          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-2 font-sans text-xs text-muted-foreground select-none">
            {!isScanned ? (
              ...
              <>
                ...
                <span className="text-xs text-muted-foreground">This folder contains no media files for review.</span>
              </>
            )}
          </div>
        </div>
          ...
          filteredItems.length > 0 ? (
            ...
            <div className="flex h-96 flex-col items-center justify-center gap-4 font-sans text-xs select-none">
              ...
              <Button
                ...
                className="h-8 cursor-pointer border-border text-xs hover:bg-accent"
              >
